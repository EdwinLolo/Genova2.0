...
function LogoEulympic() {
    ...
    if (isWideScreen) {
        return (
            <div>
                ...
                <div className="relative w-full text-center">
                    ...
                    />
                    <div className="info">
                        <h1 style={{ fontFamily: "Akbaal, sans-serif" }}>E-Ulympic</h1>
                        <p className="textEulympic" style={{ fontFamily: "SanFran-Regular, sans-serif" }}>
        ...
        return (
            <div className="EulympicPC flex relative">
                <img className="LogoPCEulympic" src={LogoEulympicPC} alt="Logo Eulympic" />
                <img className="IsiPCEulympic" src={IsiEulympicPC} alt="Isi Eulympic" />
