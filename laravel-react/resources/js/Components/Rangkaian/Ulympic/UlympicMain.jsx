    ...
    if (isWideScreen) {
        return (
            <div>
                <div className="relative w-full">
                    <img className="w-full" src={LogoUlympicPNG} alt="Logo Ulympic" />
                </div>
                <div className="relative w-full text-center">
                    ...
                    <div className="info">
                        <h1>𝐔𝐋𝐘𝐌𝐏𝐈𝐂</h1>
                        <p>
                            𝐔𝐋𝐘𝐌𝐏𝐈𝐂 adalah rangkaian perlombaan kedua sekaligus penutup perlombaan pada rangkaian kegiatan UMN Festival 2024. Akan mempertandingkan turnamen Futsal, Basket, Voli dan Badminton yang diselenggarakan untuk internal maupun eksternal UMN.
                            <br />
                            <br />
                            𝐔𝐋𝐘𝐌𝐏𝐈𝐂 juga akan dilalui bagi #Legions untuk meraih kemenangan, dalam tahap ini akan dipenuhi dengan tantangan yang memerlukan keberanian (Valiant) untuk bertarung serta kegigihan (Persistence) dari para #Legions dalam menghadapi pertarungan yang ajaib dan penuh dengan kegembiraan!
                            <br />
                            <br />
                            ...
                            <div class="card">
                                <div class="flip-card">
                                    <div class="flip-card__container">
                                        ...
                                        <div class="card-back" style={{ background: '-webkit-radial-gradient(circle, hsla(58, 100%, 68%, 1) 0%, hsla(33, 100%, 53%, 1) 100%)' }}>
                                            <img className="w-full" src={LogoCardUlympicPNG} alt="Logo Card Ulympic" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="inside-page">
                                    <div class="inside-page__container">
                                        ...
                                        <p class="inside-page__text">
                                            Sudah siap untuk dunk di lapangan? Ayo tunjukkan skill terbaikmu di Ulympic!
                                        </p>
                                        <a href="#" class="inside-page__btn inside-page__btn--city">Registrasi</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="inside-page">
                                    <div class="inside-page__container">
                                        ...
                                        <p class="inside-page__text">
                                            Raih kemenangan dengan smash terkuatmu! Ayo daftar dalam Ulympic sekarang!
                                        </p>
                                        <a href="#" class="inside-page__btn inside-page__btn--ski">Registrasi</a>
                                    </div>
                                </div>
                            </div>
                            {/* </div> */}
                            ...
                            <div class="card">
                                ...
                                <div class="inside-page">
                                    <div class="inside-page__container">
                                        ...
                                        <p class="inside-page__text">
                                            Daftarkan timmu dalam Ulympic dan tunjukkan skill kalian!
                                        </p>
                                        <a href="#" class="inside-page__btn inside-page__btn--beach">Registrasi</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="inside-page">
                                    <div class="inside-page__container">
                                        ...
                                        <p class="inside-page__text">
                                            Daftar dan spike bola menuju juara di Ulympic!
                                        </p>
                                        <a href="#" class="inside-page__btn inside-page__btn--camping">Registrasi</a>
                                    </div>
                                </div>
                            </div>
        ...
        return (
            <div className="bungkus">
                <div className="cont">
                    <div className="PCLogo"><img src={PCLogoUlympicPNG} alt="Logo Ulympic" /></div>
                ...
                <div className="cardcont w-full" style={{ backgroundImage: `url(${PCCardUlympicPNG})` }}>
