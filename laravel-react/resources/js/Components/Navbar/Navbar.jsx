...
function Navbar() {
    ...
    return (
        <div
            className={`fixed z-10 w-[95%] top-0 left-3 py-5 md:left-8 transition-all duration-300 ${
                scrolled ? "bg-opacity-100" : "bg-opacity-0"
            }`}
        >
            <div
                className={`lg:flex md:flex items-center justify-between lg:bg-opacity-0 md:bg-opacity-0 py-5 lg:px-10 md:px-10 px-7 rounded-full ${
            ...
            >
                ...
                {scrolled && (
                    <>
                        ...
                        >
                            <li className="lg:ml-5 xl:ml-8 text-xl lg:my-0 md:my-0 my-7 text-end">
                                <a
                                    href="/"
                            ...
                            <li className="text-xl lg:my-0 md:my-0 my-7 text-end">
                                <a
                                    href="/register"
                                    className="bg-gray-600 text-white px-5 md:py-2 sm:px-6 py-3 lg:px-5 lg:ml-5 md:px-6 rounded xl:ml-8 hover:bg-indigo-400 duration-500 text-center font-custom cursor-pointer"
                                >
